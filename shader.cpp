...
bool CShader::Create(wchar_t* vertFile, wchar_t* fragFile)
{
    ...
    // associate attribute index LOC_VERTEX and LOC_TEXTURE
	// with attribute variable v_vertex and v_texture
    glBindAttribLocationARB(hProgram, LOC_VERTEX, "v_vertex");
	glBindAttribLocationARB(hProgram, LOC_TEXTURE, "v_texture");
